...
TitleAndText.parameters = {
  docs: {
    description: {
      story:
        "To display the object identifier's title with descriptive text, add an additional tag below the title container and a `fd-object-identifier__text` modifier class.",
    },
  },
};
